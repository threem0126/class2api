...
var _INIT = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(option) {
        var _config_option2, database, user, password, host, port;
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _config_option2 = _config_option, database = _config_option2.database, user = _config_option2.user, password = _config_option2.password, host = _config_option2.host, port = _config_option2.port;
                        ...
                        exports.fn = fn = _sequelize2.default.fn;
                        exports.col = col = _sequelize2.default.col;
                        exports.literal = literal = _sequelize2.default.literal;
                        exports.where = where = _sequelize2.default.where;
...
var DBModelLoader = {
    ...
    INIT: function () {
        var _ref5 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee5(option, _ref6) {
