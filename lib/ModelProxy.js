...
var _bindRouter = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee4(BusinessModel, fn_beforeCall, fn_afterCall) {
        var resWrap, result, _BusinessModel, router;
    ...
    return function _bindRouter(_x, _x2, _x3) {
...
var EndPointMap_forServerRender = exports.EndPointMap_forServerRender = function () {
    ...
    return function EndPointMap_forServerRender(_x11, _x12, _x13) {
...
var CreateListenRouter = exports.CreateListenRouter = function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee7(options) {
        var apiroot, modelClasses, beforeCall, afterCall, method404, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, classObj, model, as, aPath;
        ...
        return _regenerator2.default.wrap(function _callee7$(_context7) {
            while (1) {
                switch (_context7.prev = _context7.next) {
                    ...
                    case 2:
                        apiroot = options.apiroot, modelClasses = options.modelClasses, beforeCall = options.beforeCall, afterCall = options.afterCall, method404 = options.method404;
                    ...
                    case 20:
                        ...
                        _context7.t4 = '/' + aPath;
                        _context7.next = 27;
                        return _bindRouter(model, beforeCall, afterCall);
    ...
    return function CreateListenRouter(_x14) {
