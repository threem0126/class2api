...
var CreateListenRouter = exports.CreateListenRouter = function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee7(options) {
        var apiroot, modelClasses, beforeCall, afterCall, method404, frongpage_default, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, classObj, model, as, aPath;
        ...
        return _regenerator2.default.wrap(function _callee7$(_context7) {
            while (1) {
                switch (_context7.prev = _context7.next) {
                    ...
                    case 2:
                        apiroot = options.apiroot, modelClasses = options.modelClasses, beforeCall = options.beforeCall, afterCall = options.afterCall, method404 = options.method404, frongpage_default = options.frongpage_default;
                    ...
                    case 20:
                        ...
                        _context7.t4 = '/' + aPath;
                        _context7.next = 27;
                        return _bindRouter(model, beforeCall, afterCall, frongpage_default);
